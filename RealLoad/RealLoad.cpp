...
static inline void EmitNewReturn (BYTE * & pb)
{
    ...
    666:  }
    /* // I don't know why this bullshit is here: it's BUGBUG
...
static inline EmitOutputTransform (BYTE * & pb) 
...
LISP SiodGetSystemDirectory ()
{
	...
	UINT ui = GetSystemDirectoryA (buf,  MAX_PATH) ;
	if (0 == ui)
		FormatMessageA (0x1000, 0, GetLastError (), 0, buf, MAX_PATH, 0) ;
